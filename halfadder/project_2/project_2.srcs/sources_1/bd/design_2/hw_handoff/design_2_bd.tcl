...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net adder_0_carry [get_bd_pins adder_0/carry] [get_bd_pins ila_0/probe1] [get_bd_pins vio_0/probe_in1]
  connect_bd_net -net adder_0_sum [get_bd_pins adder_0/sum] [get_bd_pins ila_0/probe0] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net clk_0_1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ila_0/clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins adder_0/a] [get_bd_pins ila_0/probe2] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins adder_0/b] [get_bd_pins ila_0/probe3] [get_bd_pins vio_0/probe_out1]
  connect_bd_net -net vio_0_probe_out2 [get_bd_pins adder_0/c] [get_bd_pins ila_0/probe4] [get_bd_pins vio_0/probe_out2]
