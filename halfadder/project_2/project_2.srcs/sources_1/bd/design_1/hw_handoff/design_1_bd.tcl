...
proc create_root_design { parentCell } {
  ...
  set c_0 [ create_bd_port -dir I c_0 ]
  set carry_0 [ create_bd_port -dir O carry_0 ]
  ...
  connect_bd_net -net a_0_1 [get_bd_ports a_0] [get_bd_pins adder_0/a] [get_bd_pins ila_0/probe0]
  connect_bd_net -net adder_0_carry [get_bd_ports carry_0] [get_bd_pins adder_0/carry] [get_bd_pins ila_0/probe4]
  connect_bd_net -net adder_0_sum [get_bd_ports sum_0] [get_bd_pins adder_0/sum] [get_bd_pins ila_0/probe3]
  connect_bd_net -net b_0_1 [get_bd_ports b_0] [get_bd_pins adder_0/b] [get_bd_pins ila_0/probe1]
  connect_bd_net -net c_0_1 [get_bd_ports c_0] [get_bd_pins adder_0/c] [get_bd_pins ila_0/probe2]
